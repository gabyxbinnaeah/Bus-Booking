...
class Bus(models.Model):
    ...
    @classmethod
    def search_buses(cls, source, destination,bus_names):
        return cls.objects.filter(source__icontains=source , destination__icontains=destination,bus_name__icontains=bus_names).all()
    def bus_details(cls):
